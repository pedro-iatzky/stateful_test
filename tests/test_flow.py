...
class TestFlowPath(object):
    ...
    def __create_task_b(self):
        b = core.Task("task_b")
        b.add_execution_task(self.__execution_task, "task_b",
                             text="task_a executed, running task_b")
        return b

    def __create_task_c(self):
        c = core.Task("task_c")
        c.add_execution_task(self.__execution_task, "task_c",
                             text="task_b executed, running task_c")
        return c
